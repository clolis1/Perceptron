...
public class PerceptronWithStopWords
{
    ...
    public PerceptronWithStopWords(double d, int x)
    {
    ...
    public void trainAndTestPerceptron()
    {
        ...
        System.out.println("The accuracy of the Perceptron training algorithm for text classification with stopWords is " + accuracyPerceptron + "%");
    }
}